...
const PolaroidPhoto: React.FC<{ url: string; position: THREE.Vector3; rotation: THREE.Euler; scale: number; id: string; shouldLoad: boolean; year: number }> = ({ url, position, rotation, scale, id, shouldLoad, year }) => {
  ...
  return (
    <group position={position} rotation={rotation} scale={scale * 1.2}>
      ...
      <mesh position={[0, 0, 0.01]} userData={{ photoId: id, photoUrl: url }}>
      ...
      {/* 扫光效果覆盖层 */}
      <mesh position={[0, 0, 0.02]} scale={[0.9, 0.9, 1]}>
...
const TreeSystem: React.FC = () => {
  ...
  const { foliageData, photosData, lightsData } = useMemo(() => {
    ...
    // 实际存在的照片文件列表
    const photoFiles = [
      "2024_06_1.webp", "2024_07_1.webp", "2024_07_2.webp",
      "2024_09_1.webp", "2024_09_2.webp", "2024_09_3.webp",
      "2024_09_4.webp", "2024_09_5.jpg", "2024_09_6.jpg",
      "2024_09_7.jpg", "2024_09_8.jpg", "2024_09_9.jpg",
      "2024_09_10.jpg", "2024_09_11.jpg","2024_09_12.jpg",
    ];
    ...
    <group ref={groupRef}>
      ...
      {photoObjects.map((obj, index) => (
        <group key={obj.id} ref={(el) => { obj.ref.current = el; }}>
          ...
          {/* Year Label - Show for every photo */}
          {obj.data.year && (
